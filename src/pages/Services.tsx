...
//     const heroClass =
//         "relative overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.08)]"

//     const heroInnerClass =
//         "px-6 py-16 text-center sm:px-8 sm:py-20"

//     const heroTitleClass =
//         "text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl"

//     const heroTextClass =
//         "mx-auto mt-6 max-w-3xl text-[15px] leading-8 text-slate-700 sm:text-base"

//     const heroButtonsClass =
//         "mt-8 flex flex-wrap items-center justify-center gap-4"

//     const primaryButtonClass =
//         "inline-flex items-center justify-center rounded-xl bg-slate-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-slate-800"

//     const secondaryButtonClass =
//         "inline-flex items-center justify-center rounded-xl border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-50"

//     const containerClass =
//         "mt-10 overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.08)]"

//     const titleWrapClass =
//         "border-b border-slate-200 px-6 py-8 sm:px-8"
...
//     const textClass =
//         "text-[15px] leading-8 text-slate-700 sm:text-base whitespace-pre-line"

//     const listClass =
//         "mt-4 list-disc space-y-2 pl-6 text-[15px] leading-8 text-slate-700 sm:text-base"
