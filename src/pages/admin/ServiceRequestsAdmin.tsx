    ...
    const filteredRequests = useMemo(() => {
        ...
        return requests.filter(r => {
            const matchesSearch =
                ...
                String(r.offeredPrice).includes(term) ||
                (r.service?.title ?? r.service?.name ?? "").toLowerCase().includes(term)
        ...
        <div className="p-6">
            <div className="flex flex-col gap-4 mb-6">
                ...
                <div className="flex flex-col lg:flex-row gap-3">
                    <input
                        type="text"
                        placeholder="Search by client, email, phone, service, message..."
                        value={search}
                                ...
                                <tr key={r.id} className="border-b last:border-b-0 hover:bg-gray-50 transition">
                                    ...
                                    <td className="p-3">
                                        <div className="flex items-center gap-2 flex-nowrap whitespace-nowrap">
                                            <Link
                                                to={`/admin/service-requests/${r.id}`}
                                            ...
                                            <Link
                                                to={`/admin/service-requests/${r.id}/edit`}
                                            ...
                                            <Link
                                                to={`/admin/service-requests/${r.id}/status`}
